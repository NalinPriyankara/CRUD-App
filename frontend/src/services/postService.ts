...
export const updatePost = (id: number | string, data: Omit<Post, 'id'>) => axios.put<Post>(`${APP_URL}/posts/${id}`, data);
export const deletePost = (id: number | string) => axios.delete(`${APP_URL}/posts/${id}`);